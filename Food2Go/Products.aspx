<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="Food2Go.Products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="style1">
        ...
        <tr>
            <td>
                <asp:DataList ID="dlFood" runat="server" RepeatColumns="3" 
                    RepeatDirection="Horizontal" onitemcommand="dlFood_ItemCommand">
                    <ItemTemplate>
                        <table class="style2">
                            <tr>
                                <td class="style10">
